...
// Checkpoints are numbered from 0 to N−1. At the start of his journey he is present at the checkpoint 0. Also checkpoint N−1 will lead to his final 
// destination.
...
// which has 0-based indexing where C[i] is the cost per litre of petrol at the ith checkpoint.
// Note that there is an infinite amount of supply at each checkpoint and car tank is also of infinite capacity. 
// Now another array L is given which has 0-based indexing where L[i] denotes the amount of petrol in litres required to reach the (i+1)th checkpoint 
// from the ith checkpoint. Note that the extra petrol remaining in the tank does not vanishes after reaching a checkpoint. 
